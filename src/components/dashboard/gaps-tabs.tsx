...
/**
 * Client-side tab nav for the Gaps section. Visually matches
 * SourcesTabs (underline indicator, active=primary, hover=primary).
 */
...
interface GapsTabsProps {
  projectId: string;
}

export function GapsTabs({ projectId }: GapsTabsProps) {
  const pathname = usePathname();
  const base = `/projects/${projectId}/gaps`;
