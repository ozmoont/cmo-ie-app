...
// Preview metadata — `robots: noindex` keeps this page out of search
// engine results while the homepage runs the teaser. Anyone who knows
// the URL can still load it (testers, internal demos), but it won't
// show up in Google. Restore the global metadata + remove this when
// /preview is collapsed back into /.
export const metadata = {
  title: "CMO.ie Preview",
