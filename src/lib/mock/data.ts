...
export const mockCompetitors: Competitor[] = [
  {
    ...
    aliases: ["MHC", "Mason Hayes & Curran"],
    regex_pattern: null,
    color: null,
    domains: ["mhc.ie"],
  ...
  },
  {
    ...
    project_id: mockProject.id,
    name: "Arthur Cox",
    display_name: "Arthur Cox",
    tracked_name: "Arthur Cox",
    aliases: [],
    regex_pattern: null,
    color: null,
    domains: ["arthurcox.com"],
  ...
  },
  {
    ...
    project_id: mockProject.id,
    name: "Matheson",
    display_name: "Matheson",
    tracked_name: "Matheson",
    aliases: [],
    regex_pattern: null,
    color: null,
    domains: ["matheson.com"],
